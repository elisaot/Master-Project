...
PRIVATE_DIRS=("data_collection/scrape-NRK/nrk_tegnspraaknytt" "data_collection/scrape-SL/videos" "data_collection/scrape-SL/unexpected_vid" "data_collection/preprocess_news/clips" "data_collection/tables" "data_collection/signpuddle/sgn69.db")  # Folders/files to remove
